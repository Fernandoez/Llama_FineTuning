...
def main():
    ...
    save_results(results, outputh_path_xlsx = "output/questoes_geradas_ZS.xlsx", outputh_path_json= "output/questoes_geradas_ZS.json")
    ...
    results = run_inference(model, tokenizer, THEMES, TOPICS_RESTRICTIONS, QUESTION_FORMAT)
    save_results(results, outputh_path_xlsx = "output/questoes_geradas_FT.xlsx", outputh_path_json= "output/questoes_geradas_FT.json")
